...
You can exercise some of these rights through your OpenAI account using the tools described in the [Data controls ⁠](https://openai.com/policies/us-privacy-policy/#data-controls) section, or you can submit your request through [privacy.openai.com⁠(opens in a new window)](https://privacy.openai.com/) or to [dsar@openai.com⁠](mailto:dsar@openai.com). You can contact our data protection officer at [dpo@openai.com⁠](mailto:dpo@openai.com).
